    ...
    <div id="header">
      ...
      <div id="menubar">
        <ul id="menu">
          ...
          <li><a href="page.html">Celebrities</a></li>
          <li><a href="#">News</a></li>
          <li><a href="register.html">Register</a></li>
          <li><a href="login.html">Login</a></li>
          <li float="right"> <?php echo $login_session; ?> </li>
        </ul>
      </div>
    </div>
    <div id="site_content">
...
<div class="row">
  <div class="column">
      <a href="index11.php">  <img src="img25.jpg" alt="Nature" style="width:100%" > </a>
  </div>
  <div class="column">
    <img src="img26.jpg" alt="Fjords" style="width:100%" onclick="myFunction(this);">
  </div>
  <div class="column">
